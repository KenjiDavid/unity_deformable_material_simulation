...
public class ABB_Gripper_Control : MonoBehaviour
{
    // Private constants.
    ...
    float forceMagnitude = 10.0f; // Magnitud de la fuerza
    ...
    //{
    //    // Obtiene el objeto con el que se colisionó
    //    GameObject otherObject = collision.gameObject;

    //    // Muestra el nombre del objeto en la consola
    //    Debug.Log($"Colisionó con: {otherObject.name}");
    //}
