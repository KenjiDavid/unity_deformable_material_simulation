...
public class MeshDeformation_1_2_cloth : MonoBehaviour
{
    ...
    void CreateVertices()
    {
        ...
        if (chargeTemplate == true)
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                vertices = JsonUtility.FromJson<Wrapper>(json).array;
            }
            else
            {
    ...
    public void SaveVector3ArrayToFile(Vector3[] vertices)
    {
        ...
        string json = JsonUtility.ToJson(new Wrapper { array = vertices }, true);
